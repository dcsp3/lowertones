...
class ContributorResourceIT {
    ...
    void createContributor() throws Exception {
        ...
        assertThat(testContributor.getInstrument()).isEqualTo(DEFAULT_INSTRUMENT);
    ...
    void putExistingContributor() throws Exception {
        ...
        updatedContributor.name(UPDATED_NAME).role(UPDATED_ROLE).instrument(UPDATED_INSTRUMENT).musicbrainzID(UPDATED_MUSICBRAINZ_ID);
        ...
        assertThat(testContributor.getInstrument()).isEqualTo(UPDATED_INSTRUMENT);
