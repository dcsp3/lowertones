...
public class ApplicationStartupRunner implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(ApplicationReadyEvent event) {
        ...
        //lol
        if (albumRepository.count() < 150) runCustomScript();
    }
    ...
    private void runCustomScript() {
        ...
        if (activeProfile.contains("prod")) {
            ...
            //run import
            try {
                //Map<Long, Long> albumIDMap = databaseImportService.importAlbums("C:\\Users\\Music\\Desktop\\PROJECTS\\Spotify Project\\SCRAPED_DATA\\FINISHED\\NEWEST\\album_table.csv");
                //Map<Long, Long> artistIDMap = databaseImportService.importArtists("C:\\Users\\Music\\Desktop\\PROJECTS\\Spotify Project\\SCRAPED_DATA\\FINISHED\\NEWEST\\artists_table.csv");
                //databaseImportService.importArtistAlbumLinks("C:\\Users\\Music\\Desktop\\PROJECTS\\Spotify Project\\SCRAPED_DATA\\FINISHED\\NEWEST\\artist_album_mapping.csv", albumIDMap, artistIDMap);
            } catch (Exception e) {
