...
public class AppUserResource {
    ...
    public ResponseEntity<AppUser> partialUpdateAppUser(
        ...
        Optional<AppUser> result = appUserRepository
            ...
            .map(existingAppUser -> {
                if (appUser.getSpotifyUserID() != null) {
                    existingAppUser.setSpotifyUserID(appUser.getSpotifyUserID());
                }
                ...
                if (appUser.getSpotifyAuthToken() != null) {
                    existingAppUser.setSpotifyAuthToken(appUser.getSpotifyAuthToken());
                }
                if (appUser.getLastLoginDate() != null) {
                    existingAppUser.setLastLoginDate(appUser.getLastLoginDate());
                }
                if (appUser.getDiscoverWeeklyBufferSettings() != null) {
                    existingAppUser.setDiscoverWeeklyBufferSettings(appUser.getDiscoverWeeklyBufferSettings());
                }
