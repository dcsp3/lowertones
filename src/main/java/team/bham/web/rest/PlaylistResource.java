    ...
    public ResponseEntity<Playlist> partialUpdatePlaylist(
        ...
        Optional<Playlist> result = playlistRepository
            ...
            .map(existingPlaylist -> {
                if (playlist.getDateAddedToDB() != null) {
                    existingPlaylist.setDateAddedToDB(playlist.getDateAddedToDB());
                }
                if (playlist.getDateLastModified() != null) {
                    existingPlaylist.setDateLastModified(playlist.getDateLastModified());
                }
                if (playlist.getPlaylistSpotifyID() != null) {
                    existingPlaylist.setPlaylistSpotifyID(playlist.getPlaylistSpotifyID());
                }
