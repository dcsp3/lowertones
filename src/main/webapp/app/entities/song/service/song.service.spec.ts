...
const requireRestSample: RestSong = {
  ...
  songDateAddedToDB: sampleWithRequiredData.songDateAddedToDB?.format(DATE_FORMAT),
  songDateLastModified: sampleWithRequiredData.songDateLastModified?.format(DATE_FORMAT),
};
